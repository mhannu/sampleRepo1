...
public class VnfprevalidateApiController implements VnfprevalidateApi {
    ...
    public ResponseEntity<BaseResponse> vnfprevalidatePost(@ApiParam(value = "Execution jenkins job id", required = true) @RequestParam(value = "uid", required = true) String uid) {
        // do some magic!
